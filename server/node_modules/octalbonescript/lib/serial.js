...
module.exports = {
	...
	enable: function(path, callback) {
		...
		bone.find_sysfsFile("ocp:" + txPin + "_pinmux", bone.is_ocp(), "ocp:" + txPin + "_pinmux", onFindPinmux);
		...
		function onWriteState(err) {
			...
			if (setTxPinState) {
				...
				setTxPinState = true;
				bone.find_sysfsFile("ocp:" + rxPin + "_pinmux", bone.is_ocp(),"ocp:" +  rxPin + "_pinmux", onFindPinmux);
			}
		}
	},
